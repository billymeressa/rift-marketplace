...
const COUNTRIES: Country[] = [
  ...
  { code: 'SS', dial: '+211', flag: '🇸🇸', name: 'South Sudan',         maxLen: 9  },
  ...
  { code: 'MA', dial: '+212', flag: '🇲🇦', name: 'Morocco',             maxLen: 9  },
  { code: 'TN', dial: '+216', flag: '🇹🇳', name: 'Tunisia',             maxLen: 8  },
  { code: 'DZ', dial: '+213', flag: '🇩🇿', name: 'Algeria',             maxLen: 9  },
  { code: 'CM', dial: '+237', flag: '🇨🇲', name: 'Cameroon',            maxLen: 9  },
  { code: 'CI', dial: '+225', flag: '🇨🇮', name: "Côte d'Ivoire",       maxLen: 10 },
  { code: 'SN', dial: '+221', flag: '🇸🇳', name: 'Senegal',             maxLen: 9  },
  { code: 'ZM', dial: '+260', flag: '🇿🇲', name: 'Zambia',              maxLen: 9  },
  { code: 'ZW', dial: '+263', flag: '🇿🇼', name: 'Zimbabwe',            maxLen: 9  },
  { code: 'MZ', dial: '+258', flag: '🇲🇿', name: 'Mozambique',          maxLen: 9  },
  // ── Middle East ───────────────────────────────────────────────────────────
  ...
  { code: 'JO', dial: '+962', flag: '🇯🇴', name: 'Jordan',              maxLen: 9  },
  { code: 'IL', dial: '+972', flag: '🇮🇱', name: 'Israel',              maxLen: 9  },
  ...
  { code: 'JP', dial: '+81',  flag: '🇯🇵', name: 'Japan',               maxLen: 10 },
  { code: 'KR', dial: '+82',  flag: '🇰🇷', name: 'South Korea',         maxLen: 10 },
  { code: 'PK', dial: '+92',  flag: '🇵🇰', name: 'Pakistan',            maxLen: 10 },
  { code: 'BD', dial: '+880', flag: '🇧🇩', name: 'Bangladesh',          maxLen: 10 },
  { code: 'LK', dial: '+94',  flag: '🇱🇰', name: 'Sri Lanka',           maxLen: 9  },
  { code: 'MY', dial: '+60',  flag: '🇲🇾', name: 'Malaysia',            maxLen: 10 },
  { code: 'SG', dial: '+65',  flag: '🇸🇬', name: 'Singapore',           maxLen: 8  },
  { code: 'ID', dial: '+62',  flag: '🇮🇩', name: 'Indonesia',           maxLen: 12 },
  { code: 'TH', dial: '+66',  flag: '🇹🇭', name: 'Thailand',            maxLen: 9  },
  { code: 'VN', dial: '+84',  flag: '🇻🇳', name: 'Vietnam',             maxLen: 10 },
  { code: 'PH', dial: '+63',  flag: '🇵🇭', name: 'Philippines',         maxLen: 10 },
  // ── Europe ────────────────────────────────────────────────────────────────
  { code: 'GB', dial: '+44',  flag: '🇬🇧', name: 'United Kingdom',      maxLen: 10 },
  { code: 'DE', dial: '+49',  flag: '🇩🇪', name: 'Germany',             maxLen: 11 },
  { code: 'FR', dial: '+33',  flag: '🇫🇷', name: 'France',              maxLen: 9  },
  { code: 'IT', dial: '+39',  flag: '🇮🇹', name: 'Italy',               maxLen: 10 },
  { code: 'ES', dial: '+34',  flag: '🇪🇸', name: 'Spain',               maxLen: 9  },
  { code: 'PT', dial: '+351', flag: '🇵🇹', name: 'Portugal',            maxLen: 9  },
  { code: 'NL', dial: '+31',  flag: '🇳🇱', name: 'Netherlands',         maxLen: 9  },
  { code: 'BE', dial: '+32',  flag: '🇧🇪', name: 'Belgium',             maxLen: 9  },
  { code: 'CH', dial: '+41',  flag: '🇨🇭', name: 'Switzerland',         maxLen: 9  },
  { code: 'AT', dial: '+43',  flag: '🇦🇹', name: 'Austria',             maxLen: 11 },
  { code: 'SE', dial: '+46',  flag: '🇸🇪', name: 'Sweden',              maxLen: 9  },
  { code: 'NO', dial: '+47',  flag: '🇳🇴', name: 'Norway',              maxLen: 8  },
  { code: 'DK', dial: '+45',  flag: '🇩🇰', name: 'Denmark',             maxLen: 8  },
  { code: 'FI', dial: '+358', flag: '🇫🇮', name: 'Finland',             maxLen: 9  },
  { code: 'PL', dial: '+48',  flag: '🇵🇱', name: 'Poland',              maxLen: 9  },
  { code: 'RU', dial: '+7',   flag: '🇷🇺', name: 'Russia',              maxLen: 10 },
  { code: 'UA', dial: '+380', flag: '🇺🇦', name: 'Ukraine',             maxLen: 9  },
  { code: 'GR', dial: '+30',  flag: '🇬🇷', name: 'Greece',              maxLen: 10 },
  // ── Americas ──────────────────────────────────────────────────────────────
  { code: 'US', dial: '+1',   flag: '🇺🇸', name: 'United States',       maxLen: 10 },
  { code: 'CA', dial: '+1',   flag: '🇨🇦', name: 'Canada',              maxLen: 10 },
  { code: 'MX', dial: '+52',  flag: '🇲🇽', name: 'Mexico',              maxLen: 10 },
  { code: 'BR', dial: '+55',  flag: '🇧🇷', name: 'Brazil',              maxLen: 11 },
  { code: 'AR', dial: '+54',  flag: '🇦🇷', name: 'Argentina',           maxLen: 10 },
  { code: 'CO', dial: '+57',  flag: '🇨🇴', name: 'Colombia',            maxLen: 10 },
  // ── Oceania ───────────────────────────────────────────────────────────────
  { code: 'AU', dial: '+61',  flag: '🇦🇺', name: 'Australia',           maxLen: 9  },
  { code: 'NZ', dial: '+64',  flag: '🇳🇿', name: 'New Zealand',         maxLen: 9  },
];
